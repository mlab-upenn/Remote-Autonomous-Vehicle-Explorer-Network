...
quad1 = Quad(17,5,0,0,0,0,(9/12));
% quad 2
quad2 = Quad(11,5,0,0,0,0,(9/12));
quad2 = quad2.setParent(quad1);
% quad 3
quad3 = Quad(9,4.5,0,0,0,0,(9/12));
quad3 = quad3.setParent(quad2);
% quad 4
quad4 = Quad(6,5.5,0,0,0,0,(9/12));
quad4 = quad4.setParent(quad3);
% quad 5
quad5 = Quad(2,5.3,0,0,0,0,(9/12));
quad5 = quad5.setParent(quad4);
...
for t = 0:dT:totalTime
    ...
    quad2 = quad2.parseCamera(dT);
    quad3 = quad3.parseCamera(dT);
    quad4 = quad4.parseCamera(dT);
    quad5 = quad5.parseCamera(dT);
