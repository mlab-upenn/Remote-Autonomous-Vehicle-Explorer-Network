...
void APM_RC_Class::Init(void)
{
  ...
  TCCR1B = (1<<WGM13)|(1<<WGM12)|(1<<CS10); //Prescaler set to 1, that give us a resolution of 0.0625us, read page 134 of data sheet
  OCR1A = 3000; //PB5, none
  OCR1B = 3000; //PB6, OUT2
  OCR1C = 3000; //PB7  OUT3
  ICR1 = 40000; //400hz freq...Datasheet says  (system_freq/prescaler)/target frequency. So (16000000hz/1)/400hz=40000,
  ...
  TCCR3B = (1<<WGM33)|(1<<WGM32)|(1<<CS31); //Prescaler set to 8, that give us a resolution of 0.5us, read page 134 of data sheet
  OCR3A = 3000; //PE3, NONE
  OCR3B = 3000; //PE4, OUT7
  OCR3C = 3000; //PE5, OUT6
  ...
  TCCR5B = (1<<WGM53)|(1<<WGM52)|(1<<CS50);//Prescaler set to 1, that give us a resolution of 0.0625us, read page 134 of data sheet
  OCR5A = 3000; //PL3,
  OCR5B = 3000; //PL4, OUT0
  OCR5C = 3000; //PL5, OUT1
  ICR5 = 40000; //400hz freq...Datasheet says  (system_freq/prescaler)/target frequency. So (16000000hz/1)/400hz=40000,
